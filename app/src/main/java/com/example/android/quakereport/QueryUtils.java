    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int counter = 0; counter < count; counter++){
                JSONObject feature_object = featuresArray.getJSONObject(counter);
                JSONObject properties_object = feature_object.getJSONObject("properties");
                String magnitude = properties_object.getString("mag");
                String place = properties_object.getString("place");
                String date = properties_object.getString("time");
